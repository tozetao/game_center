            ...
            <table class="layui-table">
                ...
                @foreach($orders as $model)
                    <tr>
                        ...
                        <td>{!! $model->translateSpecifications() !!}</td>
                        <td>{{ $model->translateStatus() }}</td>
                        <td>{{ $model->translteDeliveryStatus() }}</td>
                        <td>
                            <a class="layui-btn layui-btn-normal layui-btn-xs"
                               lay-href="{{ route('order.showDelivery', ['order_id' => $model->order_id]) }}">
                                <i class="layui-icon layui-icon-edit"></i>发货
                            </a>
                        </td>
                    </tr>
                </tbody>
